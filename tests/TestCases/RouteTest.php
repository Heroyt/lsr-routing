...
class RouteTest extends TestCase
{
    ...
    public static function getHandle(): array {
        return [
            ...
            [
                ...
                'Controller init' . PHP_EOL . 'action: ' . json_encode(
            ...
            [
                ...
                'Controller init' . PHP_EOL . 'action: <1> ' . json_encode(
                    ['controller' => 'Middleware'],
                    JSON_THROW_ON_ERROR,
                ),
            ],
            [
                ...
                '/handle3/69',
                [DummyController::class, 'actionWithParams'],
                'Controller init' . PHP_EOL . 'action: <69> ' . json_encode(
                    ['controller' => 'Middleware'],
                    JSON_THROW_ON_ERROR,
                ),
            ],
    ...
    public function test_create_duplicate(RequestMethod $method, string $route, array $routeArray): void {
        ...
        $this->router->route($method, $route, static function (): void {
            echo 'Hello!';
        });
    }
    ...
    public function test_compare_route_paths(array $path1, array $path2, bool $same): void {
